                ...
                <li>
                  <div class="activity-wrap nowrap">
                    <i class="activity-icon"
                       :style="{'background-color': '#'+ activities[0].icon_color, 'color': 'rgb(255, 255, 255)','border-color': '#'+ activities[0].icon_color}">
                    新 </i> <span class="activity-description">
                    <span>{{ activities[0].tips }}</span> <span>(APP专享)</span> </span>
                  </div>
                </li>
              </ul>
              <div class="shopheader-activity-count">
