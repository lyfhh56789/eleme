  ...
  <div id="app">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
      ...
      <defs>
        ...
        <symbol viewBox="0 0 908 1013" id="search">
          <g fill-rule="evenodd">
            <path
              d="M427.496 872.502c236.136 0 427.229-195.436 427.229-436.118S663.632.266 427.496.266.267 195.702.267 436.384 191.36 872.502 427.496 872.502zm0-72.235c-195.874 0-354.994-162.736-354.994-363.882 0-201.146 159.12-363.882 354.994-363.882 195.874 0 354.994 162.736 354.994 363.882 0 201.146-159.12 363.882-354.994 363.882zM714.583 834.684l135.487 177.464 57.415-43.834L771.998 790.85l-57.415 43.834z"></path>
          </g>
        </symbol>
      </defs>
    </svg>
